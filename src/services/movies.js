...
const movies = [
  {
    ...
    runtime: 120,
    description:
      "Nausicaä is a charismatic young princess of the peaceful Valley of the Wind. Although a skillful fighter, Nausicaä is humane and peace-loving.",
    descriptionDetail:
  ...
  },
  {
    ...
    runtime: 120,
    description:
      "It’s 1982, and Taeko is 27 years old, unmarried, and has lived her whole life in Tokyo. She decides to visit her family in the countryside, and as the train travels through.",
    descriptionDetail:
  ...
  },
  {
    ...
    runtime: 120,
    description:
      "As the human city development encroaches on the raccoon population's forest and meadow habitat, the raccoons find themselves faced with the very real possibility of extinction.",
    descriptionDetail:
  ...
  },
  {
    ...
    runtime: 120,
    description:
      "Ashitaka, a prince of the disappearing Ainu tribe, is cursed by a demonized boar god and must journey to the west to find a cure. Along the way, he encounters San, a young human woman fighting to protect the fores.",
    descriptionDetail:
